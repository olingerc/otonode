...
[
    {
        "owner": "530f92bfb063bb2d24e91975",
...
exports.import = function(req, res) {
    _.each(thesestacks, function(stack) {
        var stack = new Stack({
            title: stack.title,
            owner: "530f92fab063bb2d24e91976",
...
_.each(thesecards, function(newcard) {
        if (newcard.title != "") {
        var card = new Card({
            owner: "530f92fab063bb2d24e91976",
